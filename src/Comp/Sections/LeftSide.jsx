	...
	return (
		<AnimatePresence>
			<div className="relative border-r border-[#aa9b6c]">
				<button
					onClick={() => {
						LeftIsHidden ? ToggleLeftHide(false) : ToggleLeftHide(true);
					}}
					className="absolute right-0 top-1/2 -translate-y-1/2 translate-x-1/2 rounded-full bg-[#1a1a1a] border border-[#C2B280] p-1 transition-all duration-200 ease-in-out hover:bg-[#282424] hover:text-[#E5C07B] cursor-pointer">
